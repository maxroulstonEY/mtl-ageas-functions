...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        get_type = req.params.get('get_type')
    except KeyError:
        return {
            'statusCode': 400,
            'headers': headers,
    ...
    if get_type == "mailed":
        sql_statement = "SELECT * FROM mtl.MAILED_CASES_VW"
    elif get_type == "all":
        sql_statement = "SELECT * FROM mtl.CONTACT_QUERIES WHERE end_ts = '9999-12-31'"
    elif get_type == "open":
        sql_statement = "SELECT * FROM mtl.CONTACT_QUERIES WHERE UPPER(QUERY_STATUS) = 'OPEN' AND end_ts = '9999-12-31'"
    elif get_type == "closed":
        sql_statement = "SELECT * FROM mtl.CONTACT_QUERIES WHERE UPPER(QUERY_STATUS) = 'CLOSED' AND end_ts = '9999-12-31'"
